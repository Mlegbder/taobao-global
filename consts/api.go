...
const (
	...
	TaoBaoApiLogisticsDetail       = "/logistics/detail/get"       // 查询采购单物流详情 https://distributor.taobao.global/apps/refund/list?spm=a1zlqa.report_list.apps_refund_list.d_btn
)
