...
const (
	...
	// 商品相关接口
	TaoBaoApiQueryAllProduct = "/product/get"         // 获取商品详情接口
	...
	// 订单相关接口
	TaoBaoApiPurchaseOrderRender    = "/purchase/order/render"              // 订单预览接口
	TaoBaoApiCreatePurchaseOrder    = "/purchase/order/create"              // 创建订单接口
